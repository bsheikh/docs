...
Pair data management with your workflow tools for maximum privacy and efficiency:

<Columns cols={3}>
  <Card title="Templates" icon="grid-2-plus" href="/development">
    Standardize your notes before managing retention.
  </Card>
  <Card title="Customization" icon="sliders" href="/essentials/customization">
    Adjust formatting and structure before saving or deleting.
  </Card>
  <Card title="Learnings" icon="brain" href="/essentials/navigation">
    Apply your personal style so regenerated notes stay consistent.
  </Card>
</Columns>
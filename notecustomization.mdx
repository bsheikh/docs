...
Once you’ve customized your note, make it smarter by teaching Vero with Learnings.

<Columns cols={2}>
  <Card title="Templates" icon="grid-2-plus" href="/development">
    Create structured reusable formats before customizing.
  </Card>
  <Card title="Learnings" icon="brain" href="/essentials/navigation">
    Teach Vero your long-term style so every future note matches your preferences.
  </Card>
</Columns>
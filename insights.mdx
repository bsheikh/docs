...
Pair Insights with Learnings and Customization for a complete workflow:

<Columns cols={3}>
  <Card title="Customization" icon="sliders" href="/essentials/customization">
    Adjust detail and formatting before applying Insights.
  </Card>
  <Card title="Learnings" icon="brain" href="/essentials/navigation">
    Teach Vero your style so Insights stay aligned with your documentation.
  </Card>
  <Card title="Snippets" icon="scissors" href="/essentials/settings">
    Fill in missing exam findings or counseling phrases instantly.
  </Card>
</Columns>